        ...
        <div class="Container">
            <nav>
                <div class="nav-part-1">
                    ...
                    <div class="logo">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="278"
                            height="44" viewBox="0 0 278 44" fill="none">
        ...
        <div class="Container">
            <div class="main-brayn">
                ...
                <form id="yourForm" action="{{ route('store') }}" method="post">
                    ...
                    <!-- Historic Information form Start -->
                    <div class="brayn-box">
                    ...
                    <!-- Historic Information form End -->

                    <!-- Deal type form Start -->
                    <div class="brayn-box">
                        <h1>Deal Type</h1>
                        <div class="brayn-form">
                            <div class="brayn-in-grouop part-2">
...
document.getElementById('state').addEventListener('change', function() {
    ...
    function calculateStateRebate() {
            ...
            if (!isNaN(rebateLevel) && !isNaN(systemSize)) {
                ...
                stateRebateInput.value = `${Math.round(stateRebate.toFixed(2))}`;
                financedAmountInput.value = `${Math.round(Finance.toFixed(2))}`
                // FederalTax.value = `${Math.round(FTax.toFixed(2))}`
                FederalTax.value = `${Math.round(Math.abs(FTax).toFixed(2))}`;
                // StateTax.value = `${Math.round(value.toFixed(2))}`
                StateTax.value = `${Math.round(Math.min(Math.abs(value), 5000).toFixed(2))}`;

                TotalTax.value = `${Math.round(Math.abs(total).toFixed(2))}`
                NetCost.value = `${Math.round(Math.abs(net).toFixed(2))}`
    ...
    function calculateReamorization() {
            ...
            if (!isNaN(rLoan) && !isNaN(BasicService)) {
                ...
                LoanBasic.value = `${Math.round(sums.toFixed(2))}`;
            } else {
